			...
			$.ajax({
				...
				success:function(res){
					...
					$.each(res,function(i,item){
						...
						s+="<br>";
						s+="Age: "+item.age+"<br>";
						s+="Kor: "+(item.score.kor==null?"미응시":item.score.kor+"점");
						s+="Eng: "+(item.score.eng==null?"미응시":item.score.eng+"점");
						s+="Mat: "+(item.score.mat==null?"미응시":item.score.mat+"점");
						s+="</div>"
					});
...
<body>
	...
	<button type="button" id="btn2" class="btn btn-danger">xml데이터읽기</button>
